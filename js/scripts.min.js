...
$(function(){$("#my-menu").mmenu({extensions:["theme-black","fx-menu-slide","fx-listitems-slide","pagedim-black","position-right"],navbar:{title:'<img src="images/logo-1.svg" alt="Салон красоты Смитлер">'}});var e=$("#my-menu").data("mmenu");function s(){$(".services-carousel__item").each(function(){var e=$(this);thsh=e.find(".services-carousel__content").outerHeight(),e.find(".services-carousel__image").css("min-height",thsh)})}function i(){$(".services-carousel__content").equalHeights()}e.bind("open:start",function(){$(".hamburger").addClass("is-active")}),e.bind("close:start",function(){$(".hamburger").removeClass("is-active")}),$(".services-carousel").on("initialized.owl.carousel",function(){setTimeout(function(){s()},100)}),$(".services-carousel").owlCarousel({loop:!0,nav:!0,smartSpeed:700,navText:['<i class="fa fa-angle-double-left"></i>','<i class="fa fa-angle-double-right"></i>'],responsiveClass:!0,dots:!1,responsive:{0:{items:1},800:{items:2},1100:{items:3}}}),s(),$(".king-gallery__title, .reviews__title").each(function(){var e=$(this);e.html(e.html().replace(/^(\S+)/,"<span>$1</span>"))}),i(),window.onresize=function(){i()},$("select").selectize(),$(".reviews__carousel").owlCarousel({loop:!0,items:1,smartSpeed:700,nav:!1,autoHeight:!0}),$(".partners__carousel").owlCarousel({loop:!0,navText:['<i class="fa fa-angle-left"></i>','<i class="fa fa-angle-right"></i>'],smartSpeed:700,dots:!1,nav:!0,responsiveClass:!0,responsive:{0:{items:1},768:{items:2},992:{items:3},1200:{items:4}}}),$("form.request__callback").submit(function(){var e=$(this);return $.ajax({type:"POST",url:"/mail.php",data:e.serialize()}).done(function(){$(e).find(".request__success").addClass("active").css("display","flex").hide().fadeIn(),setTimeout(function(){$(e).find(".request__success").removeClass("active").fadeOut(),e.trigger("reset")},3e3)}),!1}),$(window).scroll(function(){$(this).scrollTop()>$(this).height()?$(".top").addClass("active"):$(".top").removeClass("active")}),$(".top").click(function(){$("html, body").stop().animate({scrollTop:0},"slow","swing")}),$(window).on("load",function(){$(".preloader").delay(200).fadeOut("slow")})});
